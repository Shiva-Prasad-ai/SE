      ...
      <section className="hero-pattern relative overflow-hidden py-6 md:py-10 border-b border-[#dbd2c3]">
        <div className="max-w-[1280px] mx-auto px-4 md:px-[48px] relative z-10 grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
          ...
          <div className="md:col-span-7 flex flex-col gap-4">
            <h1 className="font-display text-[44px] sm:text-[52px] md:text-[60px] leading-[1.1] text-[#ff6f3d] tracking-tight font-bold">
              Software <br /> Maintenance
            </h1>

            <p className="font-body-lg text-[21px] sm:text-[22px] text-[#595147] max-w-2xl leading-relaxed">
      ...
      <section className="py-12 md:py-20 bg-[#ffffff]">
        <div className="max-w-[1280px] mx-auto px-4 md:px-[48px]">
          <div className="text-center max-w-3xl mx-auto space-y-6">
            <h2 className="font-headline-lg text-[36px] text-[#ff6f3d] font-bold">Why Maintenance Matters</h2>
            <p className="font-body-md text-[20px] text-[#595147] leading-relaxed">
            ...
            <div className="pt-2">
              <button
                onClick={onGoToTypes}
                className="inline-flex items-center gap-2 text-[#ff6f3d] hover:text-[#e05524] font-headline-sm text-[24px] font-bold transition-all hover:underline cursor-pointer group"
              >
                <span>Maintenance Types</span>
                <span className="material-symbols-outlined text-[28px] transform group-hover:translate-x-1.5 transition-transform">
                  arrow_forward
                </span>
              </button>
            </div>
